                ...
                <div class="content">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="content-block">
                                                <h2>Your order has been complated</h2>
                                            </td>
                                        </tr>
                                    <tr>
                                        <td class="content-block">
                    ...
                    {{-- <div class="footer">
                        <table width="100%">
                            <tbody>
                                <tr>
                                    <td class="aligncenter content-block">Questions? Email <a href="mailto:">cs.vehicledata3000@gmail.com</a></td>
                                </tr>
                            </tbody>
                        </table>
                    </div> --}}
